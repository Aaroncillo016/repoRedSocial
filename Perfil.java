...
public class Perfil {
    ...
    if (listaAmigos.contains(amigo)) {
        ...
        System.out.println("No se encontró al amigo: " + amigo);
    }
}
...
public void reaccionarPublicacion(String publicacion, String reaccion) { System.out.println(nombre + " ha reaccionado a '" + publicacion + "' con \"" + reaccion +
\"");
}
